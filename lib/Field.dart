...
for (var i = 0; i < list.length; i++) {
  ...
  for (var n = 0; n < list[i].length; n++) {
    list[i][n] = new Sell(name: "$i - $n",  content: new Empty(sell: list[i][n]));
    print("-");
  }
}
...
for (var i = 0; i < list.length; i++) {
    ...
    for (var n = 0; n <= list.length-1; n++) {
      ...
      }if(list[i][n].content.name == "Empty" && i==0 && n==list.length-1){
              if(list[i][n-1].content.name == "Mine"){
                count++;
      ...
      }if(list[i][n].content.name == "Empty" && i==list.length-1 && n==0){
              if(list[i][n+1].content.name == "Mine"){
                count++;
      ...
      }if(list[i][n].content.name == "Empty" && i==list.length-1 && n==list.length-1){
              if(list[i][n-1].content.name == "Mine"){
                count++;
      ...
      if(list[i][n].content.name == "Empty" && n != 0 && n != list[i].length-1 && i == 0 ){
              if(list[i][n-1].content.name == "Mine"){
                count++;
              }if(list[i+1][n-1].content.name == "Mine"){
              count++;
              ...
              list[i][n].content.quantityMine = count;
      }if(list[i][n].content.name == "Empty" && n != 0 && n != list[i].length-1 && i == list.length-1 ){
              if(list[i][n-1].content.name == "Mine"){
                count++;
              }if(list[i-1][n-1].content.name == "Mine"){
              count++;
              ...
              list[i][n].content.quantityMine = count;
      }if(list[i][n].content.name == "Empty" && i != 0 && i != list.length-1 && n == 0 ){
              if(list[i-1][n].content.name == "Mine"){
                count++;
              }if(list[i-1][n+1].content.name == "Mine"){
              count++;
              ...
              list[i][n].content.quantityMine = count;
      }if(list[i][n].content.name == "Empty" && i != 0 && i != list.length-1 && n == list[i].length-1 ){
              if(list[i-1][n].content.name == "Mine"){
                count++;
              }if(list[i-1][n-1].content.name == "Mine"){
              count++;
              ...
              list[i][n].content.quantityMine = count;
      }if(list[i][n].content.name == "Empty" && i != 0 && n != 0 && i != list.length-1 && n != list[i].length-1){
          if(list[i-1][n].content.name == "Mine"){
              count++;
              }if(list[i-1][n-1].content.name == "Mine"){
              count++;
